...
const TRANSLATIONS = {
  ...
  ar: {
    ...
    contact: { title: 'سحر', titleItalic: 'الأناقة.', boutique: 'البوتيك', address: 'المدينة المنورة، المملكة العربية السعودية', inquiries: 'الاستفسارات', copyright: '© 2024 سوبيل للعطور', author: 'بواسطة فكري بلمادية' }
  }
};
